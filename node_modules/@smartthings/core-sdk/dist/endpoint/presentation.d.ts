...
import { CapabilityVisibleCondition, CapabilityLabeledState, CapabilityGrouped, CapabilityDashboardAction, CapabilityDashboardBasicPlusItem, CapabilityDetailView, CapabilityMultiArgCommand, CapabilityAutomationCondition, CapabilityAutomationAction } from './capabilities';
...
export declare class PresentationEndpoint extends Endpoint {
    ...
    get(vid: string): Promise<PresentationDeviceConfig>;
    /**
     ...
     */
    getPresentation(vid: string, mnmn?: string): Promise<PresentationDevicePresentation>;
}
