...
class SubscriptionsEndpoint extends endpoint_1.Endpoint {
    constructor(config) {
        super(new endpoint_client_1.default('installedapps', config));
    }
    /**
    ...
    create(data, installedAppId) {
        return this.client.put(`${this.installedAppId(installedAppId)}/subscriptions/`, data);
    }
    /**
     ...
     * with an installedAppId
     */
    update(name, data, installedAppId) {
        return this.client.put(`${this.installedAppId(installedAppId)}/subscriptions/${name}`, data);
    }
    /**
